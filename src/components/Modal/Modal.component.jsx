  ...
  return (
    ...
    >
      <BSModal.Body className="modal__bg">
        <div className="modal__header p-4 modal-header">
          <h3>{heading}</h3>
        </div>
        {/* <div className="modal__divider m-0" /> */}
              ...
              return (
                <Form>
                  ...
                  {customBody ? (
                    ...
                    <div className="modal__form p-4 mb-2">
                      {fields.map(
                        (
                          {
                            type,
                  ...
                  <div
                    className={`modal__buttons p-4 bg-[#0C0D0F] modal__footer
                    }`}
                  >
                  ...
                  {cancelButtonText && (
                      ...
                      onClick={handleCancel ? handleCancel : handleClose}
                        htmlType="submit"
                        loading={loading}
                        className="closeBtnForpopupMFA mt-3"
